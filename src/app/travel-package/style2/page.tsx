...
const page = () => {
  return (
    <>
      <Topbar />
      <Header />
      <Breadcrumb title="Tour Package 02" currentPage="Tour Package 02" bgImage='breadcrumb-bg3.jpg' />
      <div className="modal map-view-modal fade" id="mapViewModal" tabIndex={-1} aria-hidden="true">
          ...
          <div className="modal-content">
            ...
            <div className="title-area">
              <a href="https://www.tripadvisor.com/" className="rating-area">
                <Image width={60} height={12} src="/assets/img/innerpages/icon/tripadvisor-rating2.svg" alt="" />
                <span>134 reviews</span>
              </a>
              <h2 className="modal-title" id="ratingModalLabel">Paris &amp; Île-de-France</h2>
            ...
            <div className="modal-body">
              ...
              <div className="bottom-area">
                ...
                <Link href="/travel-package/details" className="primary-btn1 two">
                  <span>
                    Book Now
                    <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="row gy-md-5 gy-4">
                  <div className="col-md-6 item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="package-card four">
                      <div className="package-img-wrap">
                          ...
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                                <Image width={550} height={220} src="/assets/img/innerpages/tour-package-img1.jpg" alt="" />
                              </Link>
                            </div>
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                        ...
                        <a href="#" className="map-view-btn" data-bs-toggle="modal" data-bs-target="#mapViewModal">
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">Paris &amp; Île-de-France</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                        ...
                        <div className="package-content-bottom-area">
                          <ul className="package-info-list">
                            <li><span>Duration:</span> 5 Days/ 4 Nights</li>
                            <li><span>Operated:</span> English</li>
                          </ul>
                          <div className="location-area">
                            <span>Destinations: <strong>Eiffel Tower + Louvre Museum + Palace of Versailles.</strong></span>
                          </div>
                  ...
                  <div className="col-md-6 item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="package-card four">
                      <div className="package-img-wrap">
                        <Link href="/travel-package/details" className="package-img">
                          <Image width={550} height={220} src="/assets/img/innerpages/tour-package-img2.jpg" alt="" />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">Loire Valley &amp; Central France</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                        ...
                        <div className="package-content-bottom-area">
                          ...
                          <div className="location-area">
                            <span>Destinations: <strong>Château de Chambord + Arc History + Bourges Cathedra.</strong></span>
                          </div>
                          <div className="btn-and-price-area">
                            <Link href="/travel-package/details" className="primary-btn1">
                              <span>
                  ...
                  <div className="col-md-6 item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="package-card four">
                      <div className="package-img-wrap">
                        <Link href="/travel-package/details" className="package-img">
                          <Image width={550} height={220} src="/assets/img/innerpages/tour-package-img3.jpg" alt="" />
                        </Link>
                        <a href="#" className="map-view-btn" data-bs-toggle="modal" data-bs-target="#mapViewModal">
                          <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <g>
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">The Grand French Escape</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                        ...
                        <div className="package-content-bottom-area">
                          ...
                          <div className="location-area">
                            <span>Destinations: <strong>Paris + Loire Valley + French Riviera + Bordeaux.</strong></span>
                          </div>
                          <div className="btn-and-price-area">
                            <Link href="/travel-package/details" className="primary-btn1">
                              <span>
                    ...
                    <div className="package-card four">
                      <div className="package-img-wrap">
                        <div className="swiper package-card-img-slider">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                                <Image width={550} height={220} src="/assets/img/innerpages/tour-package-img4.jpg" alt="" />
                              </Link>
                            </div>
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">A Magical City Adventure</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                  ...
                  <div className="col-md-6 item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div className="package-card four">
                      <div className="package-img-wrap">
                        <Link href="/travel-package/details" className="package-img">
                          <Image width={550} height={220} src="/assets/img/home6/tour-package-img2.jpg" alt="" />
                        </Link>
                        <a href="#" className="map-view-btn" data-bs-toggle="modal" data-bs-target="#mapViewModal">
                          <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <g>
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">The French Alps Adventure</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                        ...
                        <div className="package-content-bottom-area">
                          ...
                          <div className="location-area">
                            <span>Destinations: <strong>Chamonix &amp; Mont Blanc + Annecy.</strong></span>
                          </div>
                          <div className="btn-and-price-area">
                            <Link href="/travel-package/details" className="primary-btn1">
                              <span>
                    ...
                    <div className="package-card four">
                      <div className="package-img-wrap">
                        <div className="swiper package-card-img-slider">
                          <div className="swiper-wrapper">
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                                <Image width={550} height={220} src="/assets/img/innerpages/tour-package-img5.jpg" alt="" />
                              </Link>
                            </div>
                            <div className="swiper-slide">
                              <Link href="/travel-package/details" className="package-img">
                      ...
                      <div className="package-content">
                        <div className="package-content-title-area">
                          ...
                          <h5><Link href="/travel-package/details">Cycling The Loire</Link></h5>
                          <ul className="package-features">
                            <li>
                              <svg width={10} height={10} viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.61933 3.0722L4.05903 8.6355C3.97043 8.7211 3.85813 8.7655 3.74593 8.7655C3.68772 8.76559 3.63008 8.75415 3.57632 8.73184C3.52256 8.70952 3.47376 8.67678 3.43272 8.6355L0.380725 5.5835C0.206425 5.4121 0.206425 5.1315 0.380725 4.9572L1.45912 3.8758C1.62462 3.7104 1.92002 3.7104 2.08552 3.8758L3.74593 5.5362L7.91463 1.3645C7.95569 1.32334 8.00445 1.29068 8.05814 1.26837C8.11183 1.24607 8.16939 1.23456 8.22753 1.2345C8.34563 1.2345 8.45792 1.2818 8.54063 1.3645L9.61903 2.446C9.79363 2.6203 9.79363 2.9009 9.61933 3.0722Z" />
                        ...
                        <div className="package-content-bottom-area">
                          ...
                          <div className="location-area">
                            <span>Destinations: <strong>Gateway to the Loire + Villandry + Angers.</strong></span>
                          </div>
                          <div className="btn-and-price-area">
                            <Link href="/travel-package/details" className="primary-btn1">
                              <span>
