    ...
    <>
      ...
      <div className="destination-page pt-100 mb-100">
        <div className="container">
          <ul className="nav nav-pills mb-60" id="pills-tab" role="tablist">
            ...
            <div className="tab-pane fade show active" id="pills-europe" role="tabpanel" aria-labelledby="pills-europe-tab">
              <div className="row gy-md-5 gy-4">
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img1.jpg" alt="" />
                    </Link>
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img2.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img3.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img4.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img5.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/home1/destination-img6.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img1.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img2.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img3.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img4.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img5.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                  <div className="destination-card">
                    <Link href="/destination/details" className="destination-img">
                      <Image width={355} height={155} src="/assets/img/innerpages/destination-img6.jpg" alt="" />
                    </Link>
                    <div className="destination-content">
                      <Link href="/destination/details" className="title-area">
                        <svg width={16} height={16} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
