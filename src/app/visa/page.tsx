...
const page = () => {
  return (
    <>
      <Topbar />
      <Header />
      <Breadcrumb title="Visa Package 01" currentPage="Visa Package 01" bgImage='breadcrumb-bg5.jpg' />
      <div className="visa-package-grid-section mb-100">
        <div className="container">
          <div className="row gy-5">
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img1.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">Australia</Link></h5>
                  <span>Processing Time - <strong>(15 - 30) Days</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img2.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">Canada</Link></h5>
                  <span>Processing Time - <strong>(10 - 20) Days</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img3.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">United Kingdom</Link></h5>
                  <span>Processing Time - <strong>(01 - 02) Months</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img4.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">United State</Link></h5>
                  <span>Processing Time- <strong>(01 - 03) Months</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img5.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">France</Link></h5>
                  <span>Processing Time - <strong>(01 - 02) Months</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img6.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">Germany</Link></h5>
                  <span>Processing Time - <strong>(15 - 30) Days</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img7.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">Qatar</Link></h5>
                  <span>Processing Time - <strong>(15 - 25) Days</strong></span>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="visa-package-card">
                <div className="visa-package-img">
                  <Image width={305} height={305} src="/assets/img/innerpages/visa-package-img8.jpg" alt="" />
                </div>
                <div className="visa-package-content">
                  <h5><Link href="/visa/details">Switzerland</Link></h5>
                  <span>Processing Time - <strong>(10 - 20) Days</strong></span>
                </div>
              </div>
            </div>
      ...
      <div className="why-choose-visa-section mb-100">
        <div className="container">
          ...
          <div className="row g-xl-4 g-lg-3 g-4">
            <div className="col-lg-3 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="why-choose-card">
                ...
                <h4>High Visa Approval Rate &amp; it’s 99%.</h4>
            ...
            <div className="col-lg-3 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="why-choose-card three">
                ...
                <p>We ensure <span>data privacy</span> and strict confidentiality in all applications.</p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="contact-wrapper">
            ...
            <div className="contact-img">
              <Image width={740} height={440} src="/assets/img/home8/home8-contact-img.png" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="home8-process-section two mb-100">
        <div className="container">
          <div className="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
        ...
        <div className="vector">
          <Image width={400} height={380} src="/assets/img/home8/home8-process-section-vector.png" alt="" />
        </div>
      </div>
