  ...
  return (
    <div>
      ...
      <div className="contact-page pt-100 mb-100">
                    ...
                    <div className="row g-4 mb-60">
                      ...
                      <div className="col-md-6">
                        <div className="form-inner">
                          ...
                          <SelectComponent
                            options={["Maldives", "France", "United States", "Italy", "Turkey", "Spain"]}
                      ...
                      <div className="col-md-12">
                        <div className="form-inner">
                          ...
                          <textarea placeholder="Write somethings about inquiry" defaultValue={""} />
                        </div>
                      </div>
                      <div className="col-md-12">
        ...
        <Image width={90} height={110} src="/assets/img/innerpages/vector/contact-page-vector1.svg" alt="" className="vector1" />
        <Image width={100} height={80} src="/assets/img/innerpages/vector/contact-page-vector2.svg" alt="" className="vector2" />
        <Image width={130} height={80} src="/assets/img/innerpages/vector/contact-page-vector3.svg" alt="" className="vector3" />
      </div>
