...
const HeaderStyle1V3 = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="topbar-wrap">
            ...
            <div className="topbar-right">
              ...
              <a href="#" className="primary-btn1 four transparent">
                <span>
      ...
      <header className="style-1 three">
            ...
            <ul className="menu-list">
              <li className={`menu-item-has-children  ${isHomeActive ? "active" : ""}`}>
                ...
                <ul className={`sub-menu ${state.activeMenu === "HOME" ? "d-block" : "none"}`}>
                  <li className="active"><Link href="/">Main Home</Link></li>
