...
const EnquiryModal = () => {
    ...
    // Format date for your custom display
    const formatDate = (date: Date | null) => {
        if (!date) return null;

        const optionsDay = { weekday: "long" } as const;
        const optionsDate = { day: "2-digit", month: "long" } as const;
        const dayName = date.toLocaleDateString("en-US", optionsDay);
        const dayMonth = date.toLocaleDateString("en-US", optionsDate);
        const year = date.getFullYear();

        return { dayMonth, dayName, year };
    };
                ...
                <div className="row g-4 mb-50">
                  ...
                  <div className="col-md-6">
                    <div className="form-inner">
                      ...
                      <div className="date-field-area">
                        <input type="date" name="inOut" readOnly defaultValue="Sep 12 - Sep 20" />
                  ...
                  <div className="col-lg-12">
                    <div className="form-inner">
                      ...
                      <textarea placeholder="Write about tour info" defaultValue={""} />
                    </div>
                  </div>
