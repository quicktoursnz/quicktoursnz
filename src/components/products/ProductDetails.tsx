          ...
          <div className="row gy-5 justify-content-between mb-70">
                  ...
                  >
                    <div className="product-details-tab-img">
                      <Image
                        width={550}
                        height={220}
                        src="/assets/img/innerpages/product-details-img1.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="product-details-tab-img">
                      <Image
                        width={550}
                        height={220}
                        src="/assets/img/innerpages/product-details-img2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="product-details-tab-img">
                      <Image
                        width={550}
                        height={220}
                        src="/assets/img/innerpages/product-details-img3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="col-lg-6">
              <div className="product-details-content">
                ...
                <p>
                  It provides an opportunity for people to connect with friends
                  or family members while receiving treatments together.
                </p>
                <ul>
                  <li>
                    <svg
                ...
                <div className="product-quantity d-flex align-items-center justify-content-start">
                  ...
                  <Link href="/cart=" className="primary-btn1 transparent">
                    <span>
                      Add to Cart
                      <svg
                        width={10}
                  ...
                  <Link href="/checkout" className="primary-btn1">
                    <span>
                      Buy Now
                      <svg
                        width={10}
                ...
                <ul className="aditional-info">
                  ...
                  <li>
                    <span>Tags:</span>
                    <Link href="/product-details">Fashion,</Link>{" "}
                    <Link href="/product-details">Winter</Link>
                  </li>
                </ul>
              </div>
            </div>
                ...
                >
                  ...
                  >
                    <div className="description">
                      <p>
                        The Winter Sheath Dress is a stylish and practical
                        choice for cold-weather fashion. Designed with warmth
                        and sophistication in mind, it typically features
                        insulating materials like wool, cashmere, or thick
                        knits, offering a cozy feel without sacrificing the
                        sleek, tailored silhouette characteristic of a classic
                        sheath dress.
                      </p>
                      <p>
                        Ideal for layering, the winter sheath dress can be
                        paired effortlessly with tights, scarves, and coats,
                        making it a versatile option for both work and evening
                        outings. With thoughtful details like pockets, a hint of
                        stretch for comfort, and options for belted waists, this
                        dress is perfect for the cooler months, combining
                        elegance and practicality in a timeless design.
                      </p>
                    </div>
                  </div>
                  <div
        ...
        <div className="container">
          ...
          <div className="related-product-slider-area">
                  ...
                  <div className="swiper-wrapper">
                        ...
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img2.jpg"
                              alt=""
                            />
                          </Link>
                        ...
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img5.jpg"
                              alt=""
                            />
                          </Link>
                          <Link href="/cart" className="cart-btn">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card">
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img6.jpg"
                              alt=""
                            />
                          </Link>
                          <Link href="/cart" className="cart-btn">
                        ...
                        <div className="product-card-content">
                          <h6>
                            <Link href="/product-details">Trendy Sneakers</Link>
                          </h6>
                          <span>$120.0</span>
                        </div>
                      </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="product-card">
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img7.jpg"
                              alt=""
                            />
                          </Link>
                          <Link href="/cart" className="cart-btn">
                        ...
                        <div className="product-card-content">
                          <h6>
                            <Link href="/product-details">Home Fragrance</Link>
                          </h6>
                          <span>$45.0</span>
                        </div>
                      </div>
                        ...
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img8.jpg"
                              alt=""
                            />
                          </Link>
                          <Link href="/cart" className="cart-btn">
                        ...
                        <div className="product-card-img-wrap">
                          ...
                          >
                            <Image
                              width={550}
                              height={220}
                              src="/assets/img/innerpages/product-img9.jpg"
                              alt=""
                            />
                          </Link>
                          <Link href="/cart" className="cart-btn">
            ...
            <div className="slider-btn-grp two">
              ...
              <div className="slider-btn related-product-slider-next">
                <svg
                  width={14}
                  height={14}
                  viewBox="0 0 14 14"
