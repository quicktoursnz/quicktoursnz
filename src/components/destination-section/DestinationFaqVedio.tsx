      ...
      <div className="destination-dt-faq-video-area">
        <div className="container">
          <LightGallery selector=".gallery-item"
              speed={500}
              plugins={[lgZoom, lgVideo]}  elementClassNames="video-wrap">
            <Image width={1300} height={220} src="/assets/img/innerpages/destination-dt-faq-video-img.jpg" alt="" />
            <a data-fancybox="video-player" data-src="https://www.youtube.com/watch?v=u31qwQUeGuM&t=1s"  style={{ cursor: "pointer" }} className="play-btn gallery-item">
...
export default DestinationFaqVedio
