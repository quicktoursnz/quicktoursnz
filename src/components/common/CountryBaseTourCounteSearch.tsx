...
const CountryBaseTourCounteSearch: React.FC = () => {
  ...
  return (
    <div className="single-search-box" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <input
          type="text"
          readOnly
          value={`${selected.name}, ${selected.country}`}
        />
      ...
      {isActive && (
        <div
          className={`custom-select-wrap ${isActive ? "active" : ""}`}
...
export default CountryBaseTourCounteSearch;
